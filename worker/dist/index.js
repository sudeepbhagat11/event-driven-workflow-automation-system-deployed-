    ...
    await consumer.run({
        ...
        eachMessage: async ({ topic, partition, message, heartbeat, pause }) => {
            ...
            if (currentAction.type.id === "email") {
                ...
                await (0, sendEmail_1.sendEmail)(to, body);
            }
            ...
            if (currentAction.type.id === "send-money") {
                ...
                const to = (0, parser_1.parse)(currentAction.metadata?.address, zapRunMetadata);
                console.log(to);
                console.log(amount);
                if (!amount || !to) {
                ...
                try {
                    ...
                    const paymentResult = await (0, sendStripePayment_1.sendStripePayment)(to, amount);
